...
class Configuraciones:Serializable {
    //En esta region estan todas las preguntas que se utilizaran junto con sus opciones y sus respuestas
    //region Preguntas
    //region PreguntasCine
    var preguntasCine:List<Pregunta> = listOf(
        Pregunta(
            R.string.cine1, listOf(
    ...
    var preguntasDeporte:List<Pregunta> = listOf(
        ...
        Pregunta(
            R.string.deporte5, listOf(
                Opcion(
                    "Saltar para superar una barra que esta situada a gran altura",
                    true
                ),
    ...
    var preguntasHistoria:List<Pregunta> = listOf(
        ...
        Pregunta(
            R.string.historia5, listOf(
                Opcion(
                    "Es la primera obra épica que hace referencia a la inmortalidad y la percepción humana del alma",
                    true
                ),
                Opcion(
                    "Es el primer documento escrito sobre la adopción del monoteísmo en el Medio Oriente",
                    false
                ),
                Opcion(
                    "Fue un libro de estrategia militar de 500 páginas que sirvió en la antigua Mesopotamia",
                    false
                ),
                Opcion(
                    "El tratado más antiguo que existe sobre el Inframundo",
                    false
                )
            )
        )
    ...
    //Inicialización de las categorias, a cada categoria se le pasa una lista de las preguntas que pertenecen a esa categoria
    init {
        categorias = listOf(
    ...
    //Esta funcion devuelve una lista con las categorias que se seleccionaron para usarse,
    // junto con las preguntas que pertenecen a cada categoria
